...
import { useGetClanMarketplace, useGetActiveWhyDontYouJoins, useAddWhyDontYouJoin, useCreateClanFromJoin, useJoinExistingClan, useJoinRandomClan } from '../hooks/useQueries';
...
export function ClansPage() {
  ...
  const createClan = useCreateClanFromJoin();
  const joinClan = useJoinExistingClan();
